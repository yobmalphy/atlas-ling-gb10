...
pub struct ModelConfig {
    ...
    #[serde(default)]
    pub share_expert_swiglu_limit_list: Vec<f32>,
    #[serde(default)]
    pub moe_router_groups: usize,
    #[serde(default)]
    pub moe_router_topk_groups: usize,
    ...
    #[serde(default)]
    pub gated_attention_proj_granularity_type: String,
...
pub(crate) use parsers::{
    parse_bailing_hybrid, parse_deepseek_v4, parse_gemma4_params, parse_laguna, parse_minimax_m2,
